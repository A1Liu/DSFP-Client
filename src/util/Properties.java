...
public class Properties {
     ...
     * @throws IOException if there's a problem with retrieving or parsing the file.
     */
    public static String getProperty(String documentName, String propName) throws IOException {
